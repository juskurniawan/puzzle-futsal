...
$(document).ready(function(){
  counter(5, 'http://www.tutorialweb.net');
});
        </script>
<html lang="en">
  <head>
...
$sql="SELECT *,batsa - INTERVAL '30' MINUTE as batas  from pesandp where id_member='$_GET[id_member]'";
?>
  ...
  $no=0;
	...
	<a class="btn btn-sm btn-primary tooltips" data-placement="bottom" data-original-title="Upload Struk Pembayaran" href="upload-struk.php?hal=upload-struk&id_pemesanan=<?php echo $row2['id_pemesanan']; ?>">Bayar</a>
