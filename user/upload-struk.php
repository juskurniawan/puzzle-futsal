...
?>
<?php
            $queryx = mysql_query("SELECT * FROM pesandp WHERE id_pemesanan='$_GET[id_pemesanan]'");
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
						...
						<form data-parsley-validate class="form-horizontal form-label-left" action="update-struk.php" enctype="multipart/form-data" method="post" name="form1" id="form1">
 <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Team <span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
              
                          <input type="text" id="team" name="team" value="<?php echo $datax['team'];?>" class="form-control col-md-7 col-xs-12" readonly>
                        </div>
                      </div>
                  
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Tanggal Pembayaran <span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input type="date" id="tgl" name="tgl" required="required"  class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Total <span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
             
            <input type="number" id="durasi" name="durasi" required="required" value="<?php echo $datax['total'];?>" readonly class="form-control col-md-7 col-xs-12">
            ...
            <input type="number" id="durasi" name="durasi" required="required"  value="25.000" readonly placeholder="silahkan masukan jumlah durasi booking" class="form-control col-md-7 col-xs-12">
                          
                        </div>
                      </div>
                          <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Upload Struk<span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
             
           <input name="id_pemesanan" type="hidden" id="id_pemesanan" class="form-control" value="<?php echo $datax['id_pemesanan'];?>" readonly="readonly" required />    
              <input name="filegbr" id="filegbr" type="file" />
                          
                        </div>
                      </div>
						  <tr>
						   <td align="left"><div class="col-sm-12">
