...
<table width="100%" border="1" cellspacing="2" cellpadding="2">
  ...
  $sql = "SELECT * FROM `sport`"; 
    ...
    <td width="180" bgcolor="#000000"><a href="http://localhost/gsport/admin/index.php?page=entry&cat=1&act=edit&id='.$row2['id_sport'].'">EDIT</a> - <a href="http://localhost/gsport/admin/index.php?page=entry&cat=1&act=hapus&id='.$row2['id_sport'].'">HAPUS</a></td>
  </tr>
