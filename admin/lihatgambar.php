...
?>
     <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Gambar Struk</h3>
            ...
            ?>
			<img src="gambar/<?php echo $data['struk']; ?>" width='500px'><br><br>
			<a href="index.php" class="btn btn-sm btn-danger">Kembali</a>  <br>Status Struk : <?php echo $data['ststruk'];?>
