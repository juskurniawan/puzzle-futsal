              ...
              <div class="menu_section">
				...
				<li>
				  ...
				  <li><a><i class="fa fa-edit"></i>Laporan<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="lapbooking.php">Laporan Booking</a></li>
...
?>
    ...
    <tr bgcolor="#CCCCCC" height="30">
      <td width="150">
        &nbsp;&nbsp;&nbsp;<label>
            <input name="berdasar" type="radio" value="status" /><strong>Status</strong>
        </label>
      </td>
      <td><select id="status" name="status" >
        <option>==PILIH==</option>
                <option value="Belum Membayar DP">Belum Membayar DP</option>
                <option value="Sudah Membayar DP">Sudah Membayar DP</option>
                </select></td>
